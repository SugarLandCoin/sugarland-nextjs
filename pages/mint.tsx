          ...
          (new Array(6).fill(0)).map((_, index) => {
            return (
              ...
              <Grid key={index} item xs={12} sm={6} md={4} lg={2} >
                <Stack direction="column" justifyContent='center' alignItems='center' className={classes.diamondBox}
                style={{backgroundImage:`url(${'/nft/tier'+(index+1)+'.png'})`}}
                >
                <Typography variant="subtitle1" className={classes.customBadge}>{remainingAmount[index+1]}</Typography>
...
//     color:'White',
//     boxShadow: '0px 0px 2px 2px #AB6FE9',
//     backgroundColor: 'rgba(38, 14, 238, 0.25)',
...
//                 <Stack direction="column" justifyContent='center' alignItems='center' className={classes.diamondBox}>
//                 <Box className={classes.remainDiamonds}>
//                 <Badge 
//                     anchorOrigin={{
//                       vertical: 'top',
//                       horizontal: 'right',
//                     }}
//                     badgeContent={remainingAmount[index+1] + 'NFTs'} color="primary">
                    
//                     <Image src={'/images/util/diamonds2.png'} height={'30px'} width='80px' />  
//                 </Badge>             
...
//                   <Typography variant="subtitle1">MULTIPLE NFTS</Typography>
//                   <Typography variant="label1">For Multiple NFTs, Wallet must have Combined minimum balance for all NFTs owned.</Typography>
//                   <Typography variant="label1">Each NFT Trade has built in 10% Royalties back to Sugarland&apos;ags Royalty Wallet.</Typography>
//                 </Stack>
//               </Grid>
//             </Grid>
//           </Box>
